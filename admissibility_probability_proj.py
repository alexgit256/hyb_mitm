...
a, b, n_dims = 50, min(100,n+m-kappa), 3 #(50, 100, 6) -> [50,60,...,100]
...
beta = find_beta(n+m-kappa, n, q, 3*dist_param_e) + 2
...
if beta>66:
    print(f"beta={beta} > 66... bounding by 66...")
    beta=66
if beta>49: #we don't do BKZ-50+ w/o preprocessing
...
print(f"{full_dim_succ} out of {babai_lift_success}")
